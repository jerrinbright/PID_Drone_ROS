...
class Edrone():
    ...
    def __init__(self):#def constructor
        ...
        self.target = [0.0,0.0,0.0]#setpoint 1
        self.Kp = [40000000,40000000,50.0]#5.0 Kp values declare
        self.Ki = [0.0,0.0,0.25]#ki valus declare
        self.Kd = [50000000,50000000, 1333.3]#2513 kd alus declare
        ...
        rospy.Subscriber('/lat',Float32,self.lat_call)
        rospy.Subscriber('/lon',Float32,self.lon_call)
        rospy.Subscriber('/alt',Float32,self.alt_call)
    ...
    def lat_call(self,msg):
        self.target[0]=msg.data
    def lon_call(self,msg):
        self.target[1]=msg.data
    def alt_call(self,msg):
        self.target[2]=msg.data
